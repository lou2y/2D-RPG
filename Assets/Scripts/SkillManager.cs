...
public class SkillManager : MonoBehaviour
{
    ...
    IEnumerator SkillAmount(int skillndex)
    {
        Skills[skillndex].fillAmount = 0f;
        while (Skills[skillndex].fillAmount < 1)
        {
            Skills[skillndex].fillAmount += 0.01f;
            yield return new WaitForSeconds(0.05f);
        }
        Skills[skillndex].fillAmount = 1;
